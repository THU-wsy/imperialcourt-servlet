package com.thuwsy.imperialcourt.util;
 ...
 * Description:
 * 功能1：从数据源获取数据库连接
 * 功能2：将数据源绑定到本地线程(借助 ThreadLocal)
 * 功能3：释放线程时和本地线程解除绑定
 * @Author THU_wsy
 * @Create 2023/8/21 15:43
 * @Version 1.0
 */
public class JDBCUtils {
    // 数据源成员变量设置为静态资源，保证大对象的单例性，同时保证静态方法中可以为访问
    ...
    static {
        try {
            ...
            // WEB-INF/classes目录存放编译好的 *.class 字节码文件，所以这个目录我们就称之为类路径
